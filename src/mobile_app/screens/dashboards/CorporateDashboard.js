...
export default function CorporateDashboard({ navigation, route }) {
  ...
  const { data, loading, error, refetch } = useFetch('https://demo.akulearn/api/corp-impact', {}, false); // disabled for now
  // Demo data
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>
        <MaterialCommunityIcons name="office-building" size={28} color="#007bff" />
