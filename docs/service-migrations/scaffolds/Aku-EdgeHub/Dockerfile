...
#
# Aku-EdgeHub — Offline edge server (online / PostgreSQL mode)
# For the offline / SQLite variant see Dockerfile.offline
# Multi-stage build:
...
LABEL org.opencontainers.image.source="https://github.com/oumar-code/Aku-EdgeHub"
LABEL org.opencontainers.image.version="0.1.1"
LABEL org.opencontainers.image.description="Aku-EdgeHub — offline edge server for the Aku Platform (online mode)"
